...
export function Button({ 
  ...
  const baseStyles = "font-bold py-2 px-4 rounded transition focus:outline-none focus:ring-2 focus:ring-offset-2 disabled:opacity-50 disabled:cursor-not-allowed";
